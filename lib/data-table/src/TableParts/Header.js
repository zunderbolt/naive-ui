                    ...
                    return ((0, vue_1.h)(vue_1.Fragment, null,
                        (0, vue_1.h)("div", { class: `${mergedClsPrefix}-data-table-th__title-wrapper` },
                            (0, vue_1.h)("div", { class: `${mergedClsPrefix}-data-table-th__title` }, ellipsis === true ||
                                (ellipsis && !ellipsis.tooltip) ? ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-data-table-th__ellipsis` }, renderTitle(column))) // eslint-disable-next-line @typescript-eslint/prefer-optional-chain
